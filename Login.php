...
<html>
<head>
	<title>webERP Ventana de inicio</title>
...
?>
	...
	<br />
	<span><?php echo _('Nombre de usuario'); ?>:</span><br />
	<input type="text" name="UserNameEntryField" required="required" autofocus="autofocus" maxlength="20" placeholder="<?php echo _('Nombre de usuario'); ?>" /><br />
	<span><?php echo _('Clave'); ?>:</span><br />
	<input type="password" required="required" name="Password" placeholder="<?php echo _('Clave'); ?>" /><br />
	<div id="demo_text">
<?php
