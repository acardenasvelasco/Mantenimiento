...
if (isset($Title)) {
	echo		'<div id="AppInfoDiv">',
				...
				'<div id="QuickMenuDiv">
					<ul id="menu">
						<li><a href="', $RootPath, '/index.php">', _('Menu Principal'), '</a>';
	...
	if (count($_SESSION['AllowedPageSecurityTokens'])>1){
		echo '<li><a href="', $RootPath, '/Dashboard.php">', _('Cuadro de indicadores'), '</a></li>',
			'<li><a href="', $RootPath, '/SelectCustomer.php">', _('Clientes'), '</a></li>',
			'<li><a href="', $RootPath, '/SelectProduct.php">', _('Articulos'), '</a></li>',
			'<li><a href="', $RootPath, '/SelectSupplier.php">', _('Proveedores'), '</a></li>',
			'<li><a href="', $RootPath, '/ManualContents.php', $ViewTopic, $BookMark, '" rel="external" accesskey="8">', _('Manual'), '</a></li>';
	}

	echo				'<li><a href="', $RootPath, '/Logout.php" onclick="return confirm(\'', _('Are you sure you wish to logout?'), '\');">', _('Salir'), '</a></li>',
					'</ul>',
